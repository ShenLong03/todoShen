...
using todoShen.Common.Responses;
using todoShen.Functions.Entities;

namespace todoShen.Functions.Functions
{
    public static class TodoApi
    {
        ...
        public static async Task<IActionResult> CreateTodo(
            ...
            ILogger log)
        {
            log.LogInformation("Received New Todo.");
            ...
            if (string.IsNullOrEmpty(todo?.TaskDescription))
            {
                ...
                {
                    IsSuccess = false,
                    Message = "The request must hace a Task Decription."
                });
            }
        ...
        public static async Task<IActionResult> GetAllTodo(
         ...
         ILogger log)
        {
            log.LogInformation("Get All Todo.");
