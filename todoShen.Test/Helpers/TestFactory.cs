...
using System.IO;
using System.Text;
using todoShen.Common.Models;
using todoShen.Functions.Entities;

namespace todoShen.Test.Helpers
{
    public class TestFactory
    {
        ...
        public static DefaultHttpRequest CreateHttpRequest(Guid todoId, Todo todo)
        {
            string request = JsonConvert.SerializeObject(todo);
        ...
        public static DefaultHttpRequest CreateHttpRequest(Todo todo)
        {
            string request = JsonConvert.SerializeObject(todo);
            return new DefaultHttpRequest(new DefaultHttpContext())
            {
